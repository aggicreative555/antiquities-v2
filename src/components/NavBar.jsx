...
export function NavBar() {
    ...
    return (
        <>
            <nav className="container mx-auto flex justify-between items-center px-4 transition-all duration-150 py-8">
                <Link to='/' className='p-4'> Logo
                </Link>
            ...
            <div className={`md:hidden overflow-hidden transition-all duration-150 ease-in-out ${
