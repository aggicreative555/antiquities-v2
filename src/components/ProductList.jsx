            ...
            >
              <Link to={`/products/${product.id}`} className="cursor-pointer">
                ...
                <div className="px-6 py-4 flex justify-between items-center flex-col relative">
                  <h2 className="text-xl text-center font-garamond uppercase text-red-800 mb-8">
                    {title}
                  </h2>
                  {discount ? (
                    <>
                      <p className="absolute -top-10 -right-2 bg-red-900 flex items-center justify-center w-fit aspect-square p-1 text-white font-button rounded-full hover:scale-110 hover:rotate-12 hover:translate-y-2 duration-300 transition-transform cursor-default">
                        - {discount.percentage}%
                      </p>
                      ...
                      <p className="line-through text-xs font-button text-gray-500">
                        {price} NOK
                      </p>
