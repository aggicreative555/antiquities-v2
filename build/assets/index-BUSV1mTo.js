            ...
            l: for (var tl = 0, s = g.length, E = s >>> 1; tl < E; ) {
              ...
              if (0 > Z(z, B))
                N < s && 0 > Z(K, z)
                  ? ((g[tl] = K), (g[N] = B), (tl = N))
                  : ((g[tl] = z), (g[_] = B), (tl = _));
              else if (N < s && 0 > Z(K, B)) (g[tl] = K), (g[N] = B), (tl = N);
              else break l;
            }
          }
          return O;
        ...
        function yt(g) {
          for (var O = F(A); O !== null; ) {
            if (O.callback === null) S(A);
              ...
              S(A), (O.sortIndex = O.expirationTime), yl(H, O);
            else break;
            O = F(A);
          }
        }
...
` +
  ...
  function _i(l, t, u) {
    ...
    try {
      ...
      if (
        ((kn = !1),
        (Zu !== null || ju !== null) &&
          (dn(), Zu && ((t = Zu), (l = ju), (ju = Zu = null), Oi(t), l)))
      )
  ...
  var $i = ru('animationend'),
    ki = ru('animationiteration'),
    Fi = ru('animationstart'),
    i1 = ru('transitionrun'),
    s1 = ru('transitionstart'),
    v1 = ru('transitioncancel'),
    Ii = ru('transitionend'),
    Pi = new Map(),
    yf =
  ...
  function b0(l) {
    ...
    if (((wt = 0), (ml = I = Q = null), (Ke = !1), (Va = 0), (la = null), t))
      throw Error(S(300));
    l === null ||
      Tl ||
  ...
  function Xf(l) {
    ...
    (wt = 0), (ml = I = Q = null), (Pu = !1), (Va = Je = 0), (la = null);
  }
  function xl() {
    var l = {
      memoizedState: null,
  ...
  function Zf(l, t, u) {
    ...
    if (((n = l.baseState), e === null)) l.memoizedState = n;
      ...
      if (
        (i === null ? (f = n) : (i.next = c),
        !Wl(n, l.memoizedState) && ((Tl = !0), r && ((u = Fu), u !== null)))
      )
        throw u;
      (l.memoizedState = n),
        (l.baseState = f),
  ...
  function E0(l, t, u) {
    ...
    if (
      ...
      if (
        ((a.flags |= 2048),
        ta(9, $e(), z0.bind(null, a, e, u, t), null),
        el === null)
      )
        throw Error(S(349));
      n || (wt & 124) !== 0 || A0(a, t, u);
  ...
  function p0(l, t, u) {
    ...
    return (
      u !== t.memoizedState &&
        ((Q.flags |= 2048), ta(9, $e(), T1.bind(null, e, u), null)),
      [a, n, l]
    );
  }
  function T1(l, t) {
    ...
    ts = {
      ...
      useSyncExternalStore: function (l, t, u) {
        ...
        return (
          ...
          (a.flags |= 2048),
          ta(9, $e(), z0.bind(null, a, n, u, t), null),
          u
        );
      },
      useId: function () {
  ...
  function Pe(l) {
    var t = wa;
    return (wa += 1), ua === null && (ua = []), h0(ua, l, t);
  }
  function Wa(l, t) {
  ...
  function es(l) {
    ...
    function r(y, v, d, b, M) {
      return v === null || v.tag !== 7
        ? ((v = gu(d, y.mode, b, M)), (v.return = y), v)
        : ((v = e(v, d)), (v.return = y), v);
    }
    function T(y, v, d) {
      if (
    ...
    function m(y, v, d, b, M) {
      ...
      if (typeof b == 'object' && b !== null) {
        switch (b.$$typeof) {
          case al:
            return (
              (y = y.get(b.key === null ? d : b.key) || null), i(v, y, b, M)
            );
          case Yl:
            return (
              (y = y.get(b.key === null ? d : b.key) || null), h(v, y, b, M)
            );
          case Ll:
            var x = b._init;
            return (b = x(b._payload)), m(y, v, d, b, M);
        }
        if (Ul(b) || Dl(b)) return (y = y.get(d) || null), r(v, y, b, M, null);
    ...
    function p(y, v, d, b) {
      ...
      if (Y === d.length) return u(y, U), W && Tu(y, Y), M;
      if (U === null) {
        for (; Y < d.length; Y++)
          (U = T(y, d[Y], b)),
            U !== null &&
    ...
    function q(y, v, d, b) {
      ...
      if (J.done) return u(y, U), W && Tu(y, Y), M;
      if (U === null) {
  ...
  var ms = Error(S(461)),
    Tl = !1;
  function zl(l, t, u, a) {
    t.child = l === null ? ns(t, null, u, a) : aa(t, l.child, u, a);
  }
    ...
    if (
      ...
      if (n)
        ...
        if (
          ...
          throw ((i.retryLane = a), Ju(l, a), lt(f, l, a), ms);
  ...
  function Ds(l, t, u) {
    ...
    switch (((t.lanes = 0), t.tag)) {
      case 16:
        l: {
          ...
          if (((a = e(a._payload)), (t.type = a), typeof a == 'function'))
            of(a)
              ? ((l = Du(a, l)), (t.tag = 1), (t = As(null, t, a, l, u)))
      ...
      case 1:
        return (a = t.type), (e = Du(a, t.pendingProps)), As(l, t, a, e, u);
      case 3:
        l: {
  ...
  function fn(l, t) {
    t !== null && (l.flags |= 4),
      l.flags & 16384 &&
        ((t = l.tag !== 22 ? fi() : 536870912), (l.lanes |= t), (ca |= t));
  }
  function $a(l, t) {
    if (!W)
      switch (l.tailMode) {
      ...
      if (e === 0) {
        ...
        l: {
          ...
          if ((t & 62914560) === t && ((e = Sc + 300 - St()), 10 < e)) {
            ...
            a.timeoutHandle = Ov(
              ks.bind(null, a, u, jl, yn, mc, t, it, Ru, ca, Pt, n, 2, -0, 0),
              e
            );
            break l;
          }
          ks(a, u, jl, yn, mc, t, it, Ru, ca, Pt, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function Tc() {
    if (j !== null) {
      ...
      else (l = j), (Rt = zu = null), Xf(l), (ua = null), (wa = 0), (l = j);
  ...
  function fv() {
    if (Ol === 4 || Ol === 3) {
      ...
      (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0
        ? (Ol = 5)
        : ((Ol = 0), (ia = uu = null), cv(l, l.pendingLanes));
  ...
  function X1(l, t, u) {
    ...
    a !== null && a.delete(t),
      ...
      el === l &&
        (V & u) === u &&
        (vl === 4 || (vl === 3 && (V & 62914560) === V && 300 > St() - Sc)
          ? ($ & 2) === 0 && va(l, 0)
          : (oc |= u),
        ca === V && (ca = 0)),
      Et(l);
  ...
  function vv(l, t) {
    t === 0 && (t = fi()), (l = Ju(l, t)), l !== null && (Ta(l, t), Et(l));
  }
  function Q1(l) {
    var t = l.memoizedState,
      u = 0;
...
`
  ...
  function Un(l) {
    ...
    for (var t = l.targetContainers; 0 < t.length; ) {
      ...
      } else return (t = Bu(u)), t !== null && jv(t), (l.blockedOn = u), !1;
      t.shift();
    }
    return !0;
  }
  ...
  var wv = yl.version;
  if (wv !== '19.1.0') throw Error(S(527, wv, '19.1.0'));
...
Gd.createRoot(document.getElementById('root')).render(
  ra.jsx(Rd.StrictMode, { children: ra.jsx(Xd, {}) })
);
